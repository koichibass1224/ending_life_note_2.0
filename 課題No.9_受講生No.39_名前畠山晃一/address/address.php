  ...
  <div class="row">
    <div class="col-md-12">
      <table class="table">
        ...
        <tbody>
          <tr>
          <!-- <form action="address_insert.php" method="GET"> -->
          <form action="address_insert.php" method="post">
              ...
              <td><input type="text" name="ad3"></td>
							<!-- <td><textarea name="ad1" id="" cols="30" rows="1"></textarea></td>
							<td><textarea name="ad2" id="" cols="30" rows="1"></textarea></td>
							<td><textarea name="ad3" id="" cols="30" rows="1"></textarea></td> -->
          </tr>
        </tbody>
      </table>
               <input type="submit" value="Save" class="uix-btn uix-btn__border--thin uix-btn__size--s">
            </form>
    </div>
  </div>
</div>
