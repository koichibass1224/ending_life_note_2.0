										...
										<form method="post" action="asset_insert.php">
											...
											<div class="uix-form-progress__target__step">
												<div class="uix-form-progress__content">
													...
													<div class="uix-controls is-fullwidth">
													  ...
													  <label><　?=$ad1?></label> -->
														<textarea name="ad1" id="" cols="width:100%;" rows="1"><?=$ad1?></textarea>
													</div>
													...
													<div class="uix-controls is-fullwidth">
														<textarea name="ad2" id="" cols="width:100%;" rows="1"><?=$ad2?></textarea>
													</div>
													...
													<p>an ancestor.</p>
													<div class="uix-controls is-fullwidth">
													<textarea name="ad3" id="" cols="width:100%;" rows="1"><?=$ad3?></textarea>
													</div>
													...
													<div><input type="submit" value="Save"class="uix-btn uix-btn__border--thin uix-btn__size--s"></div>
											...
											<div class="uix-form-progress__target__step">
												<div class="uix-form-progress__content">
													...
													<p>a legal heir</p>
													<div class="uix-controls is-fullwidth">
													<textarea name="ad4" id="" cols="width:100%;" rows="1"><?=$ad4?></textarea>
													</div>
													...
													<div class="uix-controls is-fullwidth">
													  ...
													  <label><　?=$ad5?></label> -->
														<textarea name="ad5" id="" cols="width:100%;" rows="1" placeholder="例：所在　新宿区白銀町　地番　○番○　不動産番号　01160000000"><?=$ad5?></textarea>
													</div>
											...
											<div class="uix-form-progress__target__step">
												...
												<div class="uix-form-progress__content">
													...
													<p>Deposits</p>
													<div class="uix-controls is-fullwidth">
														<textarea name="ad6" id="" cols="width:100%;" rows="1" placeholder="例：みずほ銀行　新宿支店　普通預金　1010000"><?=$ad6?></textarea>
													</div>
													...
													<p>Insuarance</p>
													<div class="uix-controls is-fullwidth">
														<textarea name="ad7" id="" cols="width:100%;" rows="1" placeholder="例：日本生命　証券番号　第9876543号"><?=$ad7?></textarea>
													</div>
											...
											<div class="uix-form-progress__target__step">
												...
												<div class="uix-form-progress__content">
													...
													<p>締結日</p>
													<div class="uix-controls is-fullwidth">
													<textarea name="ad8" id="" cols="width:100%;" rows="1"><?=$ad8?></textarea>
													</div>

													<h4>Step 9</h4>
													<p>相続人：住所</p>
													<div class="uix-controls is-fullwidth">
													<textarea name="ad9" id="" cols="width:100%;" rows="1"><?=$ad9?></textarea>
													</div>
