              ...
              <h4>Login to your account</h4>
							<form name="form1" action="login/login_act.php" method="post">
									...
									<div class="uix-controls uix-controls--line is-fullwidth is-iconic">
									  ...
									  <input type="text" class="js-uix-float-label" name="lid" autocomplete="off">
									  <label>Username</label>
									</div>

									<div class="uix-controls uix-controls--line is-fullwidth is-iconic">
									  <i class="fa fa-lock" aria-hidden="true"></i>
									  <input type="password" class="js-uix-float-label" name="lpw" autocomplete="off">
            ...
            <div>
              <h4>Create an account</h4>
                ...
                <form method="post" action="login/member_insert.php">
									...
									<div class="uix-controls uix-controls--line is-fullwidth is-iconic">
									  <i class="fa fa-user-o" aria-hidden="true"></i>
									  <input type="text" class="js-uix-float-label" name="u_name" autocomplete="off">
									  <label>Username</label>
									</div>

									<div class="uix-controls uix-controls--line is-fullwidth is-iconic">
									  <i class="fa fa-envelope" aria-hidden="true"></i>
									  <input type="email" class="js-uix-float-label" name="u_mail" autocomplete="off">
									  <label>Email Address</label>
                  </div>			

									<div class="uix-controls uix-controls--line is-fullwidth is-iconic">
									  <i class="fa fa-lock" aria-hidden="true"></i>
									  <input type="text" class="js-uix-float-label" name="u_pw" autocomplete="off" id="password" onkeyup="setPasswordLevel(this.value);">
                    <label>Password</label>
                  </div>
